    ...
    <div className="min-h-screen bg-background">
      <section className="relative flex flex-col items-center justify-center px-6 py-32 text-center">
        ...
        <h1 className="mb-6 max-w-3xl text-5xl font-bold tracking-tight sm:text-6xl lg:text-7xl">
          Shorten links. <span className="text-primary">Share instantly.</span>
        </h1>
        <p className="mb-10 max-w-xl text-lg text-muted-foreground leading-relaxed">
          Create short, shareable links in seconds. Manage all your URLs from a
          single dashboard.
        </p>
        ...
        <div className="mx-auto max-w-5xl">
          <div className="mb-16 text-center">
            ...
            <p className="mt-4 text-muted-foreground max-w-xl mx-auto">
              A complete toolkit for URL management and sharing.
            </p>
          </div>
          ...
          <div className="grid gap-8 sm:grid-cols-3">
            {[
              ...
              },
              {
                ...
                description:
                  'Copy and share your link anywhere you need to go.',
              },
            ].map((item) => (
              <div
                key={item.step}
      ...
      <section className="px-6 py-32 text-center">
        <div className="mx-auto max-w-2xl">
          ...
          <SignUpButton mode="modal">Create your free account</SignUpButton>
        </div>
      </section>
